...
MeshCylinder::MeshCylinder(float radius, float height, UINT stackCount, UINT sliceCount)
	: Mesh(), topRadius(radius), bottomRadius(radius), height(height), stackCount(stackCount), sliceCount(sliceCount)
{

}

MeshCylinder::MeshCylinder(float topRadius, float bottomRadius, float height, UINT stackCount, UINT sliceCount)
	: Mesh(), topRadius(topRadius), bottomRadius(bottomRadius), height(height), stackCount(stackCount), sliceCount(sliceCount)
{
