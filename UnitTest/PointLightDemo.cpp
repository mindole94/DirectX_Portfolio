...
void PointLightDemo::Initialize()
{
	...
	shader = new Shader(L"34_PointLights.fxo");
...
void PointLightDemo::PointLights()
{
	PointLight light;
	light =
	{
...
void PointLightDemo::Pass(UINT mesh, UINT model, UINT anim)
{
