#include "stdafx.h"
#include "GetAnimationBonesDemo.h"

void GetAnimationBonesDemo::Initialize()
{
...
void GetAnimationBonesDemo::Destroy()
{
	
}

void GetAnimationBonesDemo::Update()
{
...
void GetAnimationBonesDemo::Render()
{
	sky->Render();
...
void GetAnimationBonesDemo::Mesh()
{
	//Create Material
	{
...
void GetAnimationBonesDemo::Airplane()
{
...
void GetAnimationBonesDemo::Kachujin()
{
...
void GetAnimationBonesDemo::Weapon()
{
...
void GetAnimationBonesDemo::Pass(UINT mesh, UINT model, UINT anim)
{
